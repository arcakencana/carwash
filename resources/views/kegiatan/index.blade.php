    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="flex flex-wrap items-center justify-between gap-4">
                <a href="{{ route('kegiatan.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">
                    + Tambah
                </a>

                <form method="GET" action="{{ route('kegiatan.index') }}" class="flex flex-wrap items-center gap-4">
