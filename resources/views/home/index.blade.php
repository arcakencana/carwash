<x-guest-layout>
    ...
    style="background-image: url('{{ asset('images/background.png') }}');
        ...
        <div class="relative min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
            ...
            <div class="w-full sm:max-w-xl mt-6 px-6 py-4 bg-white bg-opacity-95 dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden backdrop-blur-sm">
                ...
                <div class="max-w-7xl mx-auto px-1 sm:px-1 lg:px-1 py-6">
                    <div class="grid gap-4">
                        ...
                        <div class="bg-white dark:bg-gray-900 shadow-md rounded-lg overflow-hidden border border-gray-200 hover:shadow-xl transition duration-300">
                            ...
                            <div class="p-4">
                                <h2 class="text-lg font-semibold text-gray-800 mb-1 dark:text-gray-100">
