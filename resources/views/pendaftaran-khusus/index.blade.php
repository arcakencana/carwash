<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-900 leading-tight">
            <h2 class="font-semibold text-gray-800 leading-tight">Pendaftaran All</h2>
        </h2>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="flex flex-wrap items-center justify-between gap-4">
                <a href="{{ route('pendaftaran-khusus.create', encrypt($id_kegiatan)) }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">
                    + Tambah
                </a>
                        ...
                        <tbody>
                            ...
                            <tr class="border-t hover:bg-gray-50 transition">
                                ...
                                <td class="py-2 px-4 text-center">
                                    ...
                                    <a href="{{ route('verifikasi.show', encrypt($value->pendaftaran_id)) }}" class="text-blue-600 hover:underline" target="_blank">Verifikasi</a>
                                    <span class="text-gray-400">|</span>
                                    @else
                                    <a href="{{ route('pendaftaran-khusus.show', encrypt($value->pendaftaran_id)) }}" class="text-blue-600 hover:underline">Lihat</a>
                                    <span class="text-gray-400">|</span>
                                    @endif
                                    <a href="{{ route('pendaftaran-khusus.edit', encrypt($value->pendaftaran_id)) }}" class="text-blue-600 hover:underline">Edit</a>
                                    <span class="text-gray-400">|</span>
                                    <form action="{{ route('pendaftaran-khusus.destroy', encrypt($value->pendaftaran_id)) }}" method="POST" class="inline">
                                        @csrf @method('DELETE')
                                        
                                        <input type="hidden" name="id" value="{{ encrypt($value->pendaftaran_id) }}">
