    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                <a href="{{ route('pendaftaran.create', encrypt($id_kegiatan)) }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition text-center sm:text-left w-full sm:w-auto">+ Tambah
                </a>

                <form method="GET" action="" class="flex flex-col sm:flex-row sm:items-center gap-2 w-full sm:w-auto">
                    <input 
                    type="text" 
                    name="search" 
                    placeholder="Cari..." 
